...
/*  //hcal all clus var
  double clusEHCAL[maxhcal], clusatimeHCAL[maxhcal], clustdctimeHCAL[maxhcal], blkid[maxhcal], nblk[maxhcal];
  std::vector<std::string> hcalclmemvar = {"e","atime","tdctime","id","nblk"};
  std::vector<void*> hcalclmemvar_mem = {&clusEHCAL,&clusatimeHCAL,&clustdctimeHCAL,&blkid,&nblk};
