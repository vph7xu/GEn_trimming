...
int QuasiElastic_ana_withsbsgems(const std::string configfilename, std::string filebase="/volatile/halla/sbs/vimukthi/outfiles/pass3/H2/SBSON/QE_data")
{
  ...
  //HCAL clus mem
  //double T_hcal_clus_mem_E[maxhcal]; Tout->Branch("hcal_clus_mem_e", &T_hcal_clus_mem_E, "hcal_clus_mem_e[1000]/D");
  //double T_hcal_clus_mem_atime[maxhcal]; Tout->Branch("hcal_clus_mem_atime", &T_hcal_clus_mem_atime, "hcal_clus_mem_atime[1000]/D");
  //double T_hcal_clus_mem_tdctime[maxhcal]; Tout->Branch("hcal_clus_mem_tdctime", &T_hcal_clus_mem_tdctime, "hcal_clus_mem_tdctime[1000]/D");
