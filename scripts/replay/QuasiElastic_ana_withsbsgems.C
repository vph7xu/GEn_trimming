...
int QuasiElastic_ana_withsbsgems(const std::string configfilename, std::string filebase="../outfiles/after_pass2/QE_data")
{
  ...
  std::vector<std::string> trvar = {"n","chi2","p","px","py","pz","vx","vy","vz","tg_x","tg_y","tg_th","tg_ph","r_x","r_y","r_th","r_ph"};
  std::vector<void*> trvar_mem = {&ntrack,&chi2,&p,&px,&py,&pz,&vx,&vy,&vz,&xtgt,&ytgt,&thtgt,&phtgt,&xfp,&yfp,&thfp,&phfp};
